  ...
  return (
    <div>
      <Container maxWidth='lg'>
        <GlassBox sx={{}}>
          <Card
            sx={{ maxWidth: 1, boxShadow: 'none', border: 'none', padding: '18px 35px 11px 35px' }}
          >
            <CardHeader
              sx={{
                padding: '0',
            ...
            <CardMedia
              ...
              alt='Paella dish'
            />
            <CardActions disableSpacing sx={{ padding: '0', marginBottom: '14px' }}>
                ...
                <Box key={index} sx={{ marginTop: '14px' }}>
                  <Stack direction={'row'} spacing={2}>
                    ...
                    <Box>
                      ...
                      <Box>
                        <StyleContentComment>
                          Mát xa lành mạnh. Lorem ipsum, dolor sit amet consectetur adipisicing
                          elit. Minima sint harum nostrum mollitia nisi facilis asperiores, quaerat
                          facere, debitis, eligendi neque ea iure deserunt assumenda modi tempore
                          alias nulla beatae?.Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Sequi dicta eligendi doloribus repellendus officiis iusto fugit
                          explicabo similique, accusamus sint nemo commodi voluptatem at,
                          consequatur ex nihil aut, cum esse!
                        </StyleContentComment>
                      </Box>
                    </Box>
                  </Stack>
              ...
              <Box>
                <Stack direction={'row'} spacing={2}>
                  ...
                  <Box>
                    <MainButton
                      endIcon={<Send />}
                      sx={{ height: '60px', borderRadius: '50px', padding: '15px 30px' }}
                      colorType={'primary'}
                    >
                      Gửi
                    </MainButton>
